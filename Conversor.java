public class Conversor {
    ...
    public void conversion(double cantidad, int unidadOriginal, int unidadDestino,String prefijo) {
        double resultado = 0D;
        if (unidadOriginal == unidadDestino) {
            System.out.println("Elijio la mismo unidad");
            resultado = cantidad;
            
           System.out.println("resultado = " + String.format("%.6f", resultado)+" "+prefijo);
        }
        //=================metros===========================================================
